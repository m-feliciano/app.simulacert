  ...
  faq: [
    {
      ...
      answer:
        'Sim. Você pode iniciar um simulado e praticar. Em alguns fluxos pode existir cadastro opcional para salvar histórico/estatísticas.'
    },
    {
      question: 'Quantas questões devo fazer por sessão?',
      answer:
        'Para consistência, 20–40 questões por sessão costuma funcionar bem. Para simular prova real, use 50–100 questões e mantenha o foco em tempo.'
    },
    {
      question: 'As questões são iguais às do exame oficial?',
      answer:
        'Não. O objetivo é treinar os mesmos temas e o mesmo estilo de raciocínio — não replicar banco oficial.'
    },
    {
      question: 'O que fazer depois do simulado?',
      answer:
        'Revise as explicações, anote os tópicos recorrentes e refaça um simulado focado nesses pontos até estabilizar seu desempenho.'
    }
  ],
